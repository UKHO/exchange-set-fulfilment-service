...
variable "group_name" {
    type = string
    default = "S-100 Exchange Set Service"
}

variable "group_description" {
    type = string
    default = "Management group for users with access to the S-100 Exchange Set Service."
}
...
variable "api_name" {
    type = string
    default = "S-100 Exchange Set Service API"
}
