...
namespace UKHO.ADDS.Aspire.Configuration.Seeder.Tests
{
    public class ExternalServiceDiscoParserTests
    {
        ...
        public async Task InvalidJson_ThrowsJsonException()
        {
            ...
            var exception = await Record.ExceptionAsync(() => ExternalServiceDiscoParser.ParseAndResolveAsync(AddsEnvironment.Local, json));
        ...
        {
            var json = "{\"dev\": {}}";
            var ex = await Assert.ThrowsAsync<InvalidDataException>(() => ExternalServiceDiscoParser.ParseAndResolveAsync(AddsEnvironment.Local, json));
        ...
        public async Task EndpointMissingUrl_ThrowsInvalidDataException()
        {
            ...
            await Assert.ThrowsAsync<KeyNotFoundException>(() => ExternalServiceDiscoParser.ParseAndResolveAsync(AddsEnvironment.Local, json));
        }
        ...
        public async Task EndpointWithInvalidScheme_ThrowsInvalidDataException()
        {
            ...
            await Assert.ThrowsAsync<InvalidDataException>(() => ExternalServiceDiscoParser.ParseAndResolveAsync(AddsEnvironment.Local, json));
        }
        ...
        public async Task LocalEnvironment_SinglePlaceholder_ResolvesCorrectly()
        {
            ...
            var result = await ExternalServiceDiscoParser.ParseAndResolveAsync(AddsEnvironment.Local, json);
        ...
        public async Task NonLocalEnvironment_IgnoresPlaceholders()
        {
            ...
            var result = await ExternalServiceDiscoParser.ParseAndResolveAsync(AddsEnvironment.Development, json);
            var endpoint = result[0].Endpoints[0];
        ...
        public async Task PlaceholderEnvVarMissing_ThrowsInvalidOperationException()
        {
            ...
            var ex = await Assert.ThrowsAsync<InvalidOperationException>(() => ExternalServiceDiscoParser.ParseAndResolveAsync(AddsEnvironment.Local, json));
