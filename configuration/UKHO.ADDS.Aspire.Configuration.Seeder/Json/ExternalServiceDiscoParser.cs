...
namespace UKHO.ADDS.Aspire.Configuration.Seeder.Json
{
    public static class ExternalServiceDiscoParser
    {
        ...
        public static async Task<List<RemoteServiceDefinition>> ParseAndResolveAsync(AddsEnvironment environment, string json)
        {
            ...
            var results = new List<RemoteServiceDefinition>();
            ...
            foreach (var serviceProp in envObject.EnumerateObject())
            {
                ...
                var serviceEndpoints = new List<RemoteEndpointTemplate>();
                ...
                foreach (var endpoint in endpointsArray.EnumerateArray())
                {
                    ...
                    serviceEndpoints.Add(new RemoteEndpointTemplate
                    {
                        Service = serviceName,
                        Tag = tag,
                        Scheme = scheme,
                ...
                results.Add(new RemoteServiceDefinition
                {
                    Service = serviceName,
                    ClientId = clientId,
