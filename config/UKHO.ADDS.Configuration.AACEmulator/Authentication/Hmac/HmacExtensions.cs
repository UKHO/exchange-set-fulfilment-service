...
namespace UKHO.ADDS.Configuration.AACEmulator.Authentication.Hmac
{
    public static class HmacExtensions
    {
        ...
        public static AuthenticationBuilder AddHmac(this AuthenticationBuilder builder) => builder.AddHmac(HmacDefaults.AuthenticationScheme, _ =>
        {
        });
        ...
        /// <returns>A reference to <paramref name="builder" /> after the operation has completed.</returns>
        public static AuthenticationBuilder AddHmac(this AuthenticationBuilder builder, string authenticationScheme) => builder.AddHmac(authenticationScheme, _ =>
        {
        });
        ...
        /// <returns>A reference to <paramref name="builder" /> after the operation has completed.</returns>
        public static AuthenticationBuilder AddHmac(this AuthenticationBuilder builder, Action<HmacOptions> configureOptions) => builder.AddHmac(HmacDefaults.AuthenticationScheme, configureOptions);
        ...
        /// <param name="configureOptions">A delegate that allows configuring <see cref="HmacOptions" />.</param>
        /// <returns>A reference to <paramref name="builder" /> after the operation has completed.</returns>
        public static AuthenticationBuilder AddHmac(this AuthenticationBuilder builder, string authenticationScheme, Action<HmacOptions> configureOptions) => builder.AddHmac(authenticationScheme, null, configureOptions);
