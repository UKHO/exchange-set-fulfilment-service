...
namespace UKHO.ADDS.EFS.FunctionalTests
{
    public class ProductVersionsFunctionalTests : TestBase
    {
        ...
        [InlineData("[ { \"productName\": 1234567890, \"editionNumber\": 7, \"updateNumber\": 10 } ]", "https://valid.com/callback", HttpStatusCode.BadRequest, "Either body is null or malformed.")] // Test Case 244569 - Non-string ProductName
        ...
        [InlineData(" { \"productName\": \"101GB40079ABCDEFG\", \"editionNumber\": 7, \"updateNumber\": 10 }, { \"productName\": \"102NO32904820801012\", \"editionNumber\": 36, \"updateNumber\": 0 } ", "https://valid.com/callback", HttpStatusCode.BadRequest, "Either body is null or malformed.")] // Test Case 245718 - Invalid json body
        ...
        [InlineData("", "https://valid.com/callback", HttpStatusCode.BadRequest, "Either body is null or malformed.")] // Test Case 244570 - Blank request body
