...
namespace UKHO.ADDS.EFS.FunctionalTests
{
    public class ProductNamesFunctionalTests : TestBase
    {
        ...
        [Theory]
        [InlineData(new object[] { "101GB004DEVQK" }, "https://valid.com/callback", "Single101Product.zip")] // Test Case 245610 - Product Name (S-101 product) Node Integration
        [InlineData(new object[] { "102CA005N5040W00130" }, "https://valid.com/callback", "Single102Product.zip")] // Test Case 245610 - Product Name (S-102 product) Node Integration
        [InlineData(new object[] { "104CA00_20241103T001500Z_GB3DEVK0_DCF2" }, "https://valid.com/callback", "Single104Product.zip")] // Test Case 245610 - Product Name (S-104 product) Node Integration
        [InlineData(new object[] { "111FR00_20241217T001500Z_GB3DEVK0_DCF2" }, "https://valid.com/callback", "Single111Product.zip")] // Test Case 245610 - Product Name (S-111 product) Node Integration
        [InlineData(new object[] { "111CA00_20241217T001500Z_GB3DEVQ0_DCF2", "104CA00_20241103T001500Z_GB3DEVK0_DCF2" }, "https://valid.com/callback", "MultipleProducts.zip")]   // Test Case 245610 - Product Names (multiple products) Node Integration
        public async Task ValidateProductNamesNodeInCustomAssemblyPipeline(object[] productNames, string? callbackUri, string zipFileName)
        {
            var httpClient = App!.CreateHttpClient(ProcessNames.OrchestratorService);
