...
namespace UKHO.ADDS.EFS.FunctionalTests
{
    public class ProductNamesFunctionalTests : TestBase
    {
        ...
        [Theory]
        [InlineData(new object[] { "101GB40079ABCDEFG", "102NO32904820801012", "104US00_CHES_TYPE1_20210630_0600", "111US00_ches_dcf8_20190703T00Z" }, "", HttpStatusCode.Accepted, "")] // Test Case 243519 - Valid input
        [InlineData(new object[] { "101GB40079ABCDEFG", "102NO32904820801012" }, "https://valid.com/callback", HttpStatusCode.Accepted, "")] // Test Case 243519 - Valid input with Valid callbackUri
        ...
        //// commented above test as it will cover in dev/242767-validate-product-version-update-since branch
        [InlineData(new object[] { }, "https://valid.com/callback", HttpStatusCode.BadRequest, "ProductNames cannot be null or empty.")] // Test Case 243604 - Empty array
        [InlineData(new object[] { "" }, "https://valid.com/callback", HttpStatusCode.BadRequest, "ProductNames cannot be null or empty.")] //Test Case 243605 - Array with Empty string
