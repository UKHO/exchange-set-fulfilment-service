...
namespace UKHO.ADDS.EFS.Orchestrator.UnitTests.Infrastructure.Tables.Fakes
{
    public class FakeTableTests : OrchestratorTest
    {
        ...
        public async Task UpsertAsync_InsertsOrUpdates()
        {
            ...
            await Given("An empty table", () => new FakeTable<UniqueKeyTestEntity>(
                    "Unique", e => e.Id, e => e.Id))
