...
namespace UKHO.ADDS.EFS.Orchestrator.UnitTests.Pipelines.Completion.Nodes.S100
{
    ...
    internal class SendCallbackNotificationNodeTests
    {
        ...
        {
            var exchangeSetResponse = new CustomExchangeSetResponse
            {
                Links = new ExchangeSetLinks
                {
                    ExchangeSetBatchStatusUri = TestStatusLink,
                    ExchangeSetBatchDetailsUri = TestDetailsLink
                },
                ExchangeSetUrlExpiryDateTime = DateTime.UtcNow.AddDays(1),
                RequestedProductCount = ProductCount.From(5),
                ExchangeSetProductCount = ProductCount.From(3),
                RequestedProductsAlreadyUpToDateCount = ProductCount.From(2),
                RequestedProductsNotInExchangeSet = new MissingProductList(),
                FssBatchId = TestBatchId
            };
        ...
        {
            var firstResponse = new CustomExchangeSetResponse
            {
                Links = new ExchangeSetLinks
                {
                    ExchangeSetBatchStatusUri = new Link { Uri = new Uri("https://example.com/status1") },
                    ExchangeSetBatchDetailsUri = TestDetailsLink
                },
                ExchangeSetUrlExpiryDateTime = DateTime.UtcNow.AddDays(1),
                RequestedProductCount = ProductCount.From(5),
            ...
            var secondResponse = new CustomExchangeSetResponse
            {
                Links = new ExchangeSetLinks
                {
                    ExchangeSetBatchStatusUri = new Link { Uri = new Uri("https://example.com/status2") },
                    ExchangeSetBatchDetailsUri = TestDetailsLink
                },
                ExchangeSetUrlExpiryDateTime = DateTime.UtcNow.AddDays(2),
                RequestedProductCount = ProductCount.From(10),
                ExchangeSetProductCount = ProductCount.From(8),
                RequestedProductsAlreadyUpToDateCount = ProductCount.From(2),
                RequestedProductsNotInExchangeSet = new MissingProductList(),
                FssBatchId = TestBatchId
            };
