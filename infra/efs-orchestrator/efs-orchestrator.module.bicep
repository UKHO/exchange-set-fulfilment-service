...
param efs_keyvault_outputs_vaulturi string
      ...
      containers: [
        {
          ...
          env: [
            ...
            }
            {
              ...
              value: 'http://adds-mocks-efs.internal.${efs_cae_outputs_azure_container_apps_environment_default_domain}'
            }
            {
              name: 'services__adds-mocks-efs__https__0'
              value: 'https://adds-mocks-efs.internal.${efs_cae_outputs_azure_container_apps_environment_default_domain}'
            }
            {
              name: 'ConnectionStrings__efs-keyvault'
              value: efs_keyvault_outputs_vaulturi
            }
            {
