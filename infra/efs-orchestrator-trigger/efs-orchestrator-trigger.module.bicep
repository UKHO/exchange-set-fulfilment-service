...
param funcstorage26e0b_outputs_blobendpoint string

param funcstorage26e0b_outputs_queueendpoint string

param funcstorage26e0b_outputs_tableendpoint string
      ...
      containers: [
        {
          ...
          env: [
            ...
            }
            {
              ...
              value: funcstorage26e0b_outputs_blobendpoint
            }
            {
              name: 'AzureWebJobsStorage__queueServiceUri'
              value: funcstorage26e0b_outputs_queueendpoint
            }
            {
              name: 'AzureWebJobsStorage__tableServiceUri'
              value: funcstorage26e0b_outputs_tableendpoint
            }
            {
