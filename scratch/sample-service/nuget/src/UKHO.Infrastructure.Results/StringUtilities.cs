...
namespace UKHO.Infrastructure.Results
{
    internal static class StringUtilities
    {
        ...
        {
            int stringLength = PreResultStrLength
        ...
        {
            int stringLength = PreResultStrLength + SuccessResultStrLength + PreValueStrLength + valueString.Length + PostResultStrLength;
        ...
        {
            int stringLength = PreResultStrLength + FailureResultStrLength + PreErrorStrLength + errorMessage.Length + PostErrorStrLength + PostResultStrLength;
        ...
        {
            int stringLength = type.Length + PreMessageStrLength + message.Length + PostMessageStrLength;
