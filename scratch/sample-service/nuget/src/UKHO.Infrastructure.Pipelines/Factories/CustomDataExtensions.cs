namespace UKHO.Infrastructure.Pipelines.Factories
{
    ...
    public static class CustomDataExtensions
    {
        ...
        public static IFlowComponentBuilder<T> SetCustomData<T>(this IFlowComponentBuilder<T> builder, object customData) => builder.SetMetaData(CustomDataMetaDataBuilder.MetaDataKeys.CustomData, customData);
