        ...
        public override void RegisterSingleEndpoint(IEndpointMock endpoint) =>
            endpoint.MapPost("/v2/products/{productType}/ProductVersions", async (string productType, HttpRequest request, HttpResponse response) =>
            {
                ...
                .WithEndpointMetadata(endpoint, d => ConfigureEndpointMetadata(
                    ...
                    ("Try out the get-largeexchangesets state!", "The response mimics a situation where all products have large file sizes (more than 300MB). This simulates the scenario where the exchange set will be large in size.")
                ));
    }
}
