...
namespace UKHO.ADDS.EFS.Builder.S100.Pipelines.Create
{
    ...
    internal class SignExchangeSetNode : ExchangeSetPipelineNode
    {
        ...
        protected override async Task<NodeResultStatus> PerformExecuteAsync(IExecutionContext<ExchangeSetPipelineContext> context)
        {
            ...
            var result = await context.Subject.ToolClient.SignExchangeSetAsync(context.Subject.JobId, context.Subject.WorkspaceAuthenticationKey, context.Subject.Job.GetCorrelationId());
