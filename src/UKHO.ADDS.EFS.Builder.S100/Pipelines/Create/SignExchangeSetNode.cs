...
namespace UKHO.ADDS.EFS.Builder.S100.Pipelines.Create
{
    ...
    internal class SignExchangeSetNode : S100ExchangeSetPipelineNode
    {
        ...
        protected override async Task<NodeResultStatus> PerformExecuteAsync(IExecutionContext<S100ExchangeSetPipelineContext> context)
        {
            ...
            var result = await context.Subject.ToolClient.SignExchangeSetAsync(context.Subject.JobId, context.Subject.WorkspaceName, context.Subject.WorkspaceAuthenticationKey);
