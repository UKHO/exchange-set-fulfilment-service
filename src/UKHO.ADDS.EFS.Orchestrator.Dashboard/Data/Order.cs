...
namespace UKHO.ADDS.EFS.Orchestrator.Dashboard.Data
{
    ...
    public class Customer
    {
        ...
        public Customer(string customerName) => CustomerName = customerName;
        ...
        public override string ToString() => $"{CustomerId} [{CustomerName}]";
    }
    ...
    public class Order
    {
        ...
        [Required(ErrorMessage = "Customer is required")] public Customer Customer { get; set; }
