...
namespace UKHO.ADDS.EFS.Orchestrator.Dashboard.Components.Icons
{
    public partial class IconsList : ComponentBase
    {
        private string color;
        private List<ListIcon> filteredIcons = new();

        private List<IconProvider> filterProviders = new();
        private ContentRect iconContainerRect;

        private List<ListIcon> icons = new();
        private int rotate = 0;
        private string searchText;
        private List<ListIcon> selectedIcons = new();
        private int size = 24;
        private List<IconProvider> supportedProviders = new();
        ...
        private void ClearSelected() => selectedIcons = new List<ListIcon>();
        ...
        private async Task CopyToClipboard()
        {
            ...
            await toastService.AddToastAsync(new ToastModel { Title = $"{selectedIcons.Count} icons copied to clipboard", Options = new ToastOptions { Delay = 2 } });
        }
    }
