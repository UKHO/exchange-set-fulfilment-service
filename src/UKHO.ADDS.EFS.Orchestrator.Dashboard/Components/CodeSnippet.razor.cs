...
namespace UKHO.ADDS.EFS.Orchestrator.Dashboard.Components
{
    public partial class CodeSnippet : ComponentBase
    {
        ...
        [Inject] private ICodeSnippetService CodeSnippetService { get; set; }
        [CascadingParameter] private DocsExample DocsExample { get; set; }
        ...
        private string ExampleBackground() => SetBackground ? "example-bg" : "";

        public void Dispose() => DocsExample.RemoveCodeSnippet(this);
    }
}
