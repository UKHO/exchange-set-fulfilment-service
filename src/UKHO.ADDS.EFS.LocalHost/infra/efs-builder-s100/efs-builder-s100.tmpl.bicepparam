...
param efs_storage_queue_endpoint = readEnvironmentVariable('EFS_STORAGE_QUEUEENDPOINT')
param efs_storage_blob_endpoint = readEnvironmentVariable('EFS_STORAGE_BLOBENDPOINT')
...
param azure_s100_builder_cpu = readEnvironmentVariable('AZURE_S100_BUILDER_CPU')
param azure_s100_builder_memory = readEnvironmentVariable('AZURE_S100_BUILDER_MEMORY')
param azure_s100_max_executions = int(readEnvironmentVariable('AZURE_S100_MAX_EXECUTIONS'))
param azure_s100_polling_interval = int(readEnvironmentVariable('AZURE_S100_POLLING_INTERVAL'))
