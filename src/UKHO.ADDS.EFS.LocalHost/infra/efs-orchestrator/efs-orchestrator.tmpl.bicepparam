...
param efs_app_insights_outputs_appinsightsconnectionstring = '{{ .EFS_APP_INSIGHTS_APPINSIGHTSCONNECTIONSTRING }}'
param efs_events_namespace_outputs_eventhubsendpoint = '{{ .EFS_EVENTS_NAMESPACE_EVENTHUBSENDPOINT }}'