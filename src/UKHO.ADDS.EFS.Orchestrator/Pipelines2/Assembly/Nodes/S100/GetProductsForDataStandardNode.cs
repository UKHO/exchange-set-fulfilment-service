...
namespace UKHO.ADDS.EFS.Orchestrator.Pipelines2.Assembly.Nodes.S100
{
    internal class GetProductsForDataStandardNode : AssemblyPipelineNode<S100Build>
    {
        ...
        public GetProductsForDataStandardNode(NodeEnvironment nodeEnvironment, IOrchestratorSalesCatalogueClient salesCatalogueClient)
        ...
        protected override async Task<NodeResultStatus> PerformExecuteAsync(IExecutionContext<PipelineContext<S100Build>> context)
        {
            ...
            switch (s100SalesCatalogueData.ResponseCode)
            {
                case HttpStatusCode.OK when s100SalesCatalogueData.ResponseBody.Any():
                    ...
                    await context.Subject.BuildRequired();
                ...
                case HttpStatusCode.NotModified:
                    ...
                    await context.Subject.NoBuildRequired();
