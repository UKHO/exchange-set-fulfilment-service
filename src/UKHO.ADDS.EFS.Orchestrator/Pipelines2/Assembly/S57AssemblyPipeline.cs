...
namespace UKHO.ADDS.EFS.Orchestrator.Pipelines2.Assembly
{
    ...
    {
        public S57AssemblyPipeline(AssemblyPipelineParameters parameters, AssemblyPipelineNodeFactory nodeFactory, PipelineContextFactory<S57Build> contextFactory, ILogger logger)
