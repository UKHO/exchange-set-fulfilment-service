...
namespace UKHO.ADDS.EFS.Orchestrator.Pipelines.Assembly.Nodes.S100
{
    internal class FilterProductsNode : AssemblyPipelineNode<S100Build>
    {
        ...
        public override Task<bool> ShouldExecuteAsync(IExecutionContext<PipelineContext<S100Build>> context)
        {
            ...
            return Task.FromResult(job.JobState == JobState.Created && !string.IsNullOrEmpty(job.RequestedFilter) && build.Products!.Any() && string.IsNullOrEmpty(job.RequestedProducts));
        }
