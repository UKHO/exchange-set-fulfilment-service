...
namespace UKHO.ADDS.EFS.Orchestrator.Services.Infrastructure
{
    internal interface IOrchestratorSalesCatalogueClient
    {
        ...
        /// </remarks>
        Task<(ProductVersionList s100SalesCatalogueData, DateTime? LastModified)> GetS100ProductsFromSpecificDateAsync(DateTime? sinceDateTime, Job job);
        ...
        /// </returns>
        Task<ProductEditionList> GetS100ProductNamesAsync(IEnumerable<ProductName> productNames, Job job, CancellationToken cancellationToken);
    }
}
