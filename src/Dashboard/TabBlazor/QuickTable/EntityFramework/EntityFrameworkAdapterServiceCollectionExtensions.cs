...
namespace TabBlazor.QuickTable.EntityFramework
{
    ...
    public static class EntityFrameworkAdapterServiceCollectionExtensions
    {
        ...
        public static void AddQuickTableEntityFrameworkAdapter(this IServiceCollection services) => services.AddSingleton<IAsyncQueryExecutor, EntityFrameworkAsyncQueryExecutor>();
    }
}
