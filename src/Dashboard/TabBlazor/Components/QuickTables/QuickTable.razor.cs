...
namespace TabBlazor.Components.QuickTables
{
    ...
    public partial class QuickTable<TGridItem> : IAsyncDisposable
    {
        ...
        private readonly List<ColumnBase<TGridItem>> columns;
        ...
        private readonly InternalGridContext<TGridItem> internalGridContext;
        ...
        private void FinishCollectingColumns() => collectingColumns = false;
        ...
        private string GridClass() => $"table-responsive {Class} {(pendingDataLoadCancellationTokenSource is null ? null : "loading")}";
        ...
        private void CloseColumnOptions() => displayOptionsForColumn = null;
    }
}
