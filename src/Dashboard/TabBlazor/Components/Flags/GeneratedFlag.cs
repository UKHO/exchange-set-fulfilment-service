namespace TabBlazor
{
    public class GeneratedFlag
    {
        ...
        public string DotNetProperty => $"public static IFlagType {GetSafeName()} => new {FlagType.ClassName}(\"{FlagType.Elements}\", {FlagType.Width}, {FlagType.Height}, {CountryConstuctor()});";
