...
namespace TabBlazor
{
    public partial class NavbarMenuItem : TablerBaseComponent, IDisposable
    {
        ...
        private bool NavbarIsHorizontalAndDark => Navbar?.Background == NavbarBackground.Dark && Navbar?.Direction == NavbarDirection.Top;

        private bool isDropEnd => Navbar.Direction == NavbarDirection.Top && ParentMenuItem?.IsDropdown == true;
        ...
        public void CloseDropdown() => isExpanded = false;
