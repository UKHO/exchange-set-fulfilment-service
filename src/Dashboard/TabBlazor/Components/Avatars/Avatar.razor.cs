namespace TabBlazor
{
    ...
    public partial class Avatar : TablerBaseComponent
    {
        ...
        protected override string ClassNames => ClassBuilder
            ...
            .AddCompare(Size, new Dictionary<AvatarSize, string> { { AvatarSize.Small, "avatar-sm" }, { AvatarSize.Medium, "avatar-md" }, { AvatarSize.Large, "avatar-lg" }, { AvatarSize.ExtraLarge, "avatar-xl" } })
