...
namespace TabBlazor
{
    public partial class Autocomplete<TItem> : TablerBaseComponent, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            Timer = new Timer { Interval = Debounce, AutoReset = false };
            Timer.Elapsed += async (sender, args) => await DoSearch();
        }

        protected override void OnParametersSet() => UpdateInput();
        ...
        private bool SearchTextInAutoCompleteList(string input, IEnumerable<TItem> listResult) => listResult.Any();
        ...
        private void Close() => IsShowingSuggestions = false;
