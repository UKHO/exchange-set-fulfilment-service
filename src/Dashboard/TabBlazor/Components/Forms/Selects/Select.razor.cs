...
namespace TabBlazor
{
    public partial class Select<TItem, TValue> : TablerBaseComponent
    {
        ...
        protected override void OnParametersSet() => PopulateItemList();

        protected bool IsSelected(TValue value) => EqualityComparer<TValue>.Default.Equals(SelectedValue, value);
        ...
        private void PopulateItemList()
        {
            ...
            if (Items != null)
            {
                ...
                {
                    var listItem = new ListItem<TItem, TValue> { Text = GetText(item), Value = GetValue(item), Item = item };
