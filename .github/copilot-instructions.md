...
2. **Code Organization:**
   ...
   - Use file-scoped namespace declarations: `namespace UKHO.ADDS.EFS.Domain;`
...
4. **Language Features:**
   ...
   - Use implicit typing (var) only when the type is obvious from the right side of the assignment
   - Use async/await for asynchronous operations
   - Use using statements for resources that implement IDisposable
   - Use LINQ for clearer collection manipulation, with proper indentation
